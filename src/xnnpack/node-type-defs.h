...
XNN_ENUM_ITEM(xnn_node_type_abs, "Abs")
XNN_ENUM_ITEM(xnn_node_type_add2, "Add2")
...
XNN_ENUM_ITEM(xnn_node_type_bankers_rounding, "Bankers Rounding")
XNN_ENUM_ITEM(xnn_node_type_batch_matrix_multiply, "Batch Matrix Multiply")
XNN_ENUM_ITEM(xnn_node_type_ceiling, "Ceiling")
XNN_ENUM_ITEM(xnn_node_type_clamp, "Clamp")
...
XNN_ENUM_ITEM(xnn_node_type_copysign, "Copy Sign")
...
XNN_ENUM_ITEM(xnn_node_type_divide, "Divide")
XNN_ENUM_ITEM(xnn_node_type_elu, "ELU")
XNN_ENUM_ITEM(xnn_node_type_exp, "Exp")
...
XNN_ENUM_ITEM(xnn_node_type_even_split_n, "Even SplitN")
XNN_ENUM_ITEM(xnn_node_type_floor, "Floor")
...
XNN_ENUM_ITEM(xnn_node_type_gelu, "GELU")
...
XNN_ENUM_ITEM(xnn_node_type_hardswish, "HardSwish")
XNN_ENUM_ITEM(xnn_node_type_log, "Log")
XNN_ENUM_ITEM(xnn_node_type_leaky_relu, "Leaky ReLU")
XNN_ENUM_ITEM(xnn_node_type_max_pooling_2d, "Max Pooling 2D")
XNN_ENUM_ITEM(xnn_node_type_maximum2, "Maximum2")
XNN_ENUM_ITEM(xnn_node_type_minimum2, "Minimum2")
XNN_ENUM_ITEM(xnn_node_type_multiply2, "Multiply2")
XNN_ENUM_ITEM(xnn_node_type_negate, "Negate")
XNN_ENUM_ITEM(xnn_node_type_prelu, "PReLU")
XNN_ENUM_ITEM(xnn_node_type_reciprocal_square_root, "Reciprocal Square Root")
...
XNN_ENUM_ITEM(xnn_node_type_sigmoid, "Sigmoid")
XNN_ENUM_ITEM(xnn_node_type_softmax, "Softmax")
XNN_ENUM_ITEM(xnn_node_type_space_to_depth_2d, "Space To Depth 2D")
XNN_ENUM_ITEM(xnn_node_type_square, "Square")
XNN_ENUM_ITEM(xnn_node_type_square_root, "Square Root")
XNN_ENUM_ITEM(xnn_node_type_squared_difference, "Squared Difference")
...
XNN_ENUM_ITEM(xnn_node_type_subtract, "Subtract")
XNN_ENUM_ITEM(xnn_node_type_tanh, "Tanh")
